...
<head>
    ...
    <title>uCard</title>
    <!-- FAV and TOUCH ICONS -->
    <link rel="shortcut icon" href="http://themes.pixelwars.org/images/ico/favicon.ico">
    <link rel="apple-touch-icon" href="http://themes.pixelwars.org/images/ico/apple-touch-icon.png">
    <!-- FONTS -->
    ...
    <script src="http://themes.pixelwars.org/js/modernizr.min.js"></script>
...
<body>
                            ...
                            <div class="page-bottom">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <!-- GOOGLE MAP -->
                                        <div class="map">
                                            <div data-latitude="29.720157" data-longitude="-95.4013379" data-zoom="4" data-marker-image="http://themes.pixelwars.org/images/site/marker.png" id="map-canvas" class="map-canvas"></div>
                                        </div>
                                        <!-- GOOGLE MAP -->
                                    </div>
                                    <!-- .col-md-6 -->
    ...
    <!-- InstanceEndEditable -->
    <!-- SCRIPTS -->
    <script src="http://themes.pixelwars.org/js/jquery.address-1.5.min.js"></script>
    <script src="http://themes.pixelwars.org/js/nprogress/nprogress.js"></script>
    <script src="http://themes.pixelwars.org/js/fastclick.js"></script>
    <script src="http://themes.pixelwars.org/js/typist.js"></script>
    <script src="http://themes.pixelwars.org/js/imagesloaded.pkgd.min.js"></script>
    <script src="http://themes.pixelwars.org/js/jquery.isotope.min.js"></script>
    <script src="http://themes.pixelwars.org/js/jquery.fitvids.js"></script>
    <script src="http://themes.pixelwars.org/js/jquery.validate.min.js"></script>
    <script src="http://themes.pixelwars.org/js/jquery.magnific-popup/jquery.magnific-popup.min.js"></script>
    ...
    <!--
        ...
        -->
    <script src="http://themes.pixelwars.org/js/main.js"></script>
</body>
<!-- InstanceEnd -->
